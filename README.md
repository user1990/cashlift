...
The shared CashLift wordmark is a stable 5.03:1 traced vector in [`src/ui/assets/logo.svg`](./src/ui/assets/logo.svg) and is rendered inline in the marketing, auth, checkout, and workspace shells. The favicon uses the compact traced [`public/brand/cashlift-icon.svg`](./public/brand/cashlift-icon.svg) mark.
