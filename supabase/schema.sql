...
insert into cash_actions (
	...
	('action-protect-buffer', 'studio-nova', 'cash-buffer', 'Protect the $250k cash buffer', 'Payroll and contractor bills land before the largest client payment. Keep non-essential purchases pending until May 15.', 940000, '2026-05-13', 'high', 'Kuvro', 'open', array['owner-finance']),
