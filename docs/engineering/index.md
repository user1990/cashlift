...
- [Validation contracts](/engineering/validation-contracts) — establish trusted runtime data at every boundary.
- [Data fetching and mutations](/engineering/data-fetching) — keep server data, client cache, and optimistic UI consistent.
- [Forms and input](/engineering/forms-and-input) — build accessible forms with shared Zod contracts.
