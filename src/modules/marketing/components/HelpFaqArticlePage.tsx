	...
	<MainContent variant="marketing">
		<article className="mx-auto max-w-4xl">
			<nav aria-label="Help article navigation">
				<Link
					href={returnHref}
					className="inline-flex min-h-11 items-center gap-2 rounded-md font-medium text-m text-shell-muted outline-none transition-colors duration-150 hover:text-primary focus-ring motion-reduce:transition-none"
				>
