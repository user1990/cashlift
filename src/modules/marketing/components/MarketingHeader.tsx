...
const MarketingBrand = ({ onNavigate }: { onNavigate: () => void }) => (
	<Link className="shrink-0" href="/" onClick={onNavigate}>
		<div className="flex items-center gap-2.5">
			<div className="size-[34px] shrink-0 transition-[width,height] duration-300 ease-in-out [@container_scroll-state(stuck:top)]:w-[22px] [@container_scroll-state(stuck:top)]:h-[22px]"></div>

			<Image src={logo} alt="CashLift Logo" className="shrink-0" width={36} height={36} />
