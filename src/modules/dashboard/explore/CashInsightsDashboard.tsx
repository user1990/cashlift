...
export const CashInsightsDashboard = ({ basePath, dashboard, presentation }: CashInsightsDashboardProps) => {
	...
	return (
		<div className="space-y-4 xl:space-y-5">
			...
			<CockpitSupportCard title="Payroll and reserve context">
				<div className="min-w-0 lg:col-span-7">
					...
					<Link className="mt-3 inline-flex min-h-11 items-center text-m text-primary hover:underline" href={basePath}>
						Back to overview
					</Link>
				</div>
